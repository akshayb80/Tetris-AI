function GameManager() {
    ...
    function startTurn() {
        ...
        if (isAiActive) {
            ...
            selectElement = document.getElementById('levels');
            var d=Number(selectElement.value);
            isKeyEnabled = true;
            if(d==1) gravityTimer.resetForward(500);
            else if(d==2) gravityTimer.resetForward(200);
            else gravityTimer.resetForward(50);
            
        }
    }

    document.getElementById("levels").addEventListener("change", startTurn);
